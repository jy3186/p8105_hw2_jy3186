...
The total weight of trash collected by Professor Trash Wheel is `r sum(pull(proftrashwheel_df, weight_tons))`.

The total number of sports balls collected by Mr. Trash Wheel in 2020 is `r sum(pull(mrtrashwheel_2020, sports_balls))`.

---End of Problem 2---

## Problem 3

Importing and cleaning the data pols-month
```{r}
pols_month_df= 
