...
The row size of the combined dataset is 524. The column size of the
combined dataset is 15. The total weight of trash collected by Professor
Trash Wheel is 135.5. The total number of sports balls collected by
